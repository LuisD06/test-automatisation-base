...
Feature: TA Automatización de pruebas para aplicación de gestión de personajes de Marvel - Marvel Characters API
  ...
  @id:2 @CreacionPersonaje @CreacionDePersonajeValida
  ...
  @id:3 @EliminacionPersonaje @EliminacionDePersonajePorIdValida
  ...
  @id:10 @EliminacionPersonaje @EliminacionDePersonajeNoExistente
